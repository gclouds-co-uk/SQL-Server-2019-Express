...
variable "source_image" {
  ...
  type        = string
  default     = "projects/mpi-gclouds-public/global/images/gclouds-win2019-sql2019-exp-golden-1778549815"
}
